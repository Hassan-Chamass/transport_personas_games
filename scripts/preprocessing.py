...
def get_trip_constants_from_data(trip_data: dict, fares_data: dict,
    ...
    consts: dict[str, int | float] = {
        ...
        "DIST_STOP_TO_INTERCHANGE":  round(seg["walk_stop_to_interchange"]["dist_km"] * 1000),
        "DIST_HOME_TO_INTERCHANGE":  round(seg["taxi_home_to_interchange"]["dist_km"] * 1000),
        ...
        "CO2E_TAXI_HOME_INTERCHANGE": co2e(seg["taxi_home_to_interchange"]["dist_km"], f_taxi),
        ...
        "TIME_TAXI_HOME_INTERCHANGE_CLEAR":  seg["taxi_home_to_interchange"]["time_min"]["clear"],
        "TIME_TAXI_HOME_INTERCHANGE_RAIN":   seg["taxi_home_to_interchange"]["time_min"]["rain"],
        "TIME_TAXI_HOME_INTERCHANGE_SEVERE": seg["taxi_home_to_interchange"]["time_min"]["severe"],
        ...
        "TIME_WALK_STOP_TO_INTERCHANGE": seg["walk_stop_to_interchange"]["time_min"],
        ...
        "TAXI_HOME_INTERCHANGE_FARE_BASE": round(taxi_init + seg["taxi_home_to_interchange"]["dist_km"] * taxi_pkm),
